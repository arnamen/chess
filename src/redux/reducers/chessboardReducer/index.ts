...
const chessboardCreate = (state: StateInterface, action: actionTypes) => {
    ...
    newChessboard[1] = [BLACK.EMPTY,BLACK.EMPTY,BLACK.EMPTY,BLACK.EMPTY,BLACK.EMPTY,BLACK.EMPTY,BLACK.EMPTY,BLACK.EMPTY];
    //white side
    newChessboard[6] = [WHITE.EMPTY,WHITE.EMPTY,WHITE.EMPTY,WHITE.EMPTY,WHITE.EMPTY,WHITE.EMPTY,WHITE.EMPTY,WHITE.EMPTY];
